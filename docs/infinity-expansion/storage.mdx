...
<ImageGallery images={[
  { src: '/images/infinity-expansion/storage-empty.png', alt: '空存储单元'}
]} />
...
<ImageGallery images={[
  { src: '/images/infinity-expansion/storage-status.png', alt: '存储单元状态'}
]} />
...
<ImageGallery images={[
  { src: '/images/infinity-expansion/storage-interactions.png', alt: '快捷操作'}
]} />
...
<ImageGallery images={[
  { src: '/images/infinity-expansion/storage-sign.png', alt: '告示牌'}
]} />
