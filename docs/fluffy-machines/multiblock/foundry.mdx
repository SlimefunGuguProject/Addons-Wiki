...
<ImageGallery images={[
  { src: '/images/fluffy-machines/foundry-setup-1.png', alt: '建造铸造厂1', sizePercent: 50 }
]} />

2. 右键点击超热炉，会弹出以下提示。<br />
这表示铸造厂建造无误，如果没有弹出注册成功的提示，请拆除后重新摆放。

<ImageGallery images={[
  { src: '/images/fluffy-machines/foundry-setup-2.png', alt: '建造铸造厂2' }
]} />
...
<ImageGallery images={[
  { src: '/images/fluffy-machines/foundry-setup-3.png', alt: '建造铸造厂3', sizePercent: 50 }
]} />

4. 完成，现在你可以*右键点击*超热炉来使用铸造厂了。
...
<ImageGallery images={[
  { src: '/images/fluffy-machines/foundry-gui.png', alt: '铸造厂界面' }
]} />
